            ...
            <div class="row align-items-center">
                <div class="col-xl-3">
                    <div class="footer-logo">
                        <a class="icon-masking" href="index.html"><span data-mask-src="{{ url('/assets/logo/logo-small.png') }}" class="mask-icon"></span><img src="{{ url('/assets/logo/logo-small.png') }}" alt="Webteck"></a>
                    </div>
                </div>
                <div class="col-xl-9">
