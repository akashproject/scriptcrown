				...
				<div class="row">
					<div class="col-md-8" >
						<div class="form-group row mb-3">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="full_name" id="full_name" placeholder="Enter Full Name Here" >
							</div>
						</div>
						<div class="form-group row mb-3">
							<label for="email_address" class="col-sm-3 text-right control-label col-form-label">Email Address</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" name="email_address" id="email_address" placeholder="Enter Email Address Here" >
							</div>
						</div>
						<div class="form-group row mb-3">
							<label for="mobile_number" class="col-sm-3 text-right control-label col-form-label">Mobile Number</label>
							<div class="col-sm-9">
								<input type="number" class="form-control" name="mobile_number" id="mobile_number" placeholder="Enter Mobile Number Here" >
							</div>
						</div>
						<div class="form-group row mb-3">
							<label for="whatsapp_number" class="col-sm-3 text-right control-label col-form-label">Whatsapp Number</label>
							<div class="col-sm-9">
								<input type="number" class="form-control" name="whatsapp_number" id="whatsapp_number" placeholder="Enter Mobile Number Here" >
							</div>
						</div>
						<div class="form-group row mb-3">
							<label for="city" class="col-sm-3 text-right control-label col-form-label">City</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" name="city" id="city" placeholder="Enter City Here" >
							</div>
						</div>
						<div class="form-group row mb-3">
							<label for="state" class="col-sm-3 text-right control-label col-form-label">State</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" name="state" id="state" placeholder="Enter State Here" >
							</div>
						</div>
						<div class="form-group row mb-3">
							<label for="country" class="col-sm-3 text-right control-label col-form-label">Country</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" name="country" id="country" placeholder="Enter Country Here" >
							</div>
						</div>
						<div class="form-group row mb-3">
						...
						<div class="mb-3 row">
							...
							<div class="col-sm-9">
								<textarea class="form-control" name="requirement" id="requirement" placeholder="Enter Requirement Here" ></textarea>
							</div>
						</div>
						...
						<div class="form-group row mb-2">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="lead_type" id="lead_type" placeholder="Enter Utm Source Here"  value="SEO">
							</div>
						</div>
					</div>
					<div class="col-md-4">	
