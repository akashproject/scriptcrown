				...
				<div class="row">
					<div class="col-md-7" >
						<div class="mb-3 row">
							...
							<div class="col-md-9">
								<input name="name" class="form-control" type="text" value="" id="name" placeholder="Enter Project Name Here" >
							</div>
						</div>
						<div class="mb-3 row">
							<label for="name" class="col-md-3 col-form-label">Slug</label>
							<div class="col-md-9">
								<input name="slug" class="form-control" type="text" value="" id="name" placeholder="Enter Project Slug Here" >
							</div>
						</div>
						<div class="mb-3 row">
					...
					<div class="col-md-5">
						...
						<div class="mb-2 row">
							<label for="tags" class="col-sm-6 text-left control-label col-form-label">Banner</label>
							<div class="col-sm-6">
								<a href="#imageBox" class="image-profile open-popup-link">
				...
				<div class="row">
					<div class="col-md-7" >
						...
						<div class="mb-2 row">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="robots" id="robots" placeholder="Enter Project Pincode Here" value="index, follow" >
							</div>
						</div>
					</div>
