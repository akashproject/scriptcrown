		...
		<form class="form-horizontal" method="post" action="{{ route('admin-save-technology') }}" enctype="multipart/form-data">
			...
			<div class="card-body">
				...
				<div class="row">
					<div class="col-md-7" >
						<div class="mb-3 row">
							<label for="name" class="col-md-3 text-right control-label col-form-label">Name</label>
							<div class="col-md-9">
								<input name="name" class="form-control" type="text" value="" id="name" placeholder="Enter Business Name Here" >
							</div>
						</div>
						<div class="mb-3 row">
							<label for="name" class="col-md-3 text-right control-label col-form-label">Slug</label>
							<div class="col-md-9">
								<input name="slug" class="form-control" type="text" value="" id="name" placeholder="Enter Business Slug Here" >
							</div>
						</div>
						<div class="mb-2 row">
							<label for="title" class="col-sm-3 text-right control-label col-form-label">Title</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" name="title" id="title" placeholder="Enter Banner Title Here" >
							</div>
						</div>
						<div class="mb-3 row">
				...
				<div class="row">
					<div class="col-md-7" >
						...
						<div class="mb-2 row">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="utm_campaign" id="utm_campaign" value="Google_Organic" placeholder="Enter Utm Campaign Here" >
							</div>
						</div>
						...
						<div class="mb-2 row">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="utm_source" id="utm_source" value="SEO" placeholder="Enter Utm Source Here" >
							</div>
						</div>
						<div class="mb-2 row">
							<label for="robots" class="col-sm-3 text-right control-label col-form-label">Robots Content</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" name="robots" id="robots" placeholder="Enter Business Pincode Here" value="index, follow" >
							</div>
						</div>
					</div>
					<div class="col-md-5" >
