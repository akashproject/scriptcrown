	...
	<div class="card">
		<div class="card-header d-flex flex-wrap justify-content-between gap-3">
			<div class="card-title mb-0 me-1">
				<h5 class="mb-1"> {{ count($businesses) }} Records found</h5>
			</div>
			<div class="d-flex justify-content-md-end align-items-center gap-3 flex-wrap mb-3" >
				<div class="dt-buttons btn-group flex-wrap mb-0">
					<a class="btn create-new btn-primary" href="{{ route('admin-add-business') }} ">
						<span>
						...
						<tr>
							...
							<td>
								<div class="d-inline-block text-nowrap">
									<a href="{{ route('admin-businesses',$value->slug) }}" class="btn btn-sm btn-icon">
