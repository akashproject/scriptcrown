				...
				<div class="card-body">
										...
										<tr>
											<td>{{ $value->name }}
												<div>
													...
													<a href="{{ route('admin-delete-tech-type',$value->id) }}" class=""; >Delete </a>
												</div>
											</td>													
											<td>{{ $value->slug }}</td>
											<td>
											<a href="{{ route('admin-tech-types',$value->id) }}" class="">4</a>
											</td>
										</tr>
										@endforeach							
									</tbody>
					...
					<div class="border-top">
						<div class="card-body">
							...
							<input type="hidden" name="techType_id" id="techType_id" value="" >
						</div>
					</div>
				</form>
			</div>
