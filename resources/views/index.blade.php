@extends('layouts.main')
    ...
    <div class="th-hero-wrapper hero-2" id="hero">
        <div class="slider-area">
            <div class="swiper th-slider hero-slider-2" id="heroSlider2" data-slider-options='{"autoHeight":"true","effect":"fade","breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"1"},"992":{"slidesPerView":"1"},"1200":{"slidesPerView":"1"}}}'>
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="th-hero-slide">
                            <div class="th-hero-bg" data-bg-src="{{ url('assets/frontend/img/hero/hero_bg_2_2.jpg') }}"></div>
                            <div class="container">
                                <div class="hero-style2">
                                    <div class="ripple-shape">
                                        <span class="ripple-1"></span><span class="ripple-2"></span><span class="ripple-3"></span><span class="ripple-4"></span><span class="ripple-5"></span><span class="ripple-6"></span>
                    ...
                    <div class="swiper-slide">
                        <div class="th-hero-slide">
                            <div class="th-hero-bg" data-bg-src="{{ url('assets/frontend/img/hero/hero_bg_2_3.jpg') }}"></div>
                            <div class="container">
                                <div class="hero-style2">
                                    <div class="ripple-shape">
                                        <span class="ripple-1"></span><span class="ripple-2"></span><span class="ripple-3"></span><span class="ripple-4"></span><span class="ripple-5"></span><span class="ripple-6"></span>
        ...
        <div class="hero-shape2">
            <img src="{{ url('assets/frontend/img/hero/hero_shape_2_2.png') }}" alt="shape">
        </div>
        <div class="hero-shape3">
            <img src="{{ url('assets/frontend/img/hero/hero_shape_2_3.png') }}" alt="shape">
        </div>
    </div>
            ...
            <div class="row gy-4">
                <div class="col-md-6 col-xl-4">
                    <div class="service-card">
                        ...
                        <div class="shape-icon">
                            <img src="{{ url('assets/frontend/img/icon/service_card_1.svg') }}" alt="Icon">
                        ...
                        <div class="bg-shape">
                            <img src="{{ url('assets/frontend/img/bg/service_card_bg.png') }}" alt="bg">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="service-card">
                        ...
                        <div class="shape-icon">
                            <img src="{{ url('assets/frontend/img/icon/service_card_2.svg') }}" alt="Icon">
                            <span class="dots"></span>
                        </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="service-card">
                        ...
                        <div class="shape-icon">
                            <img src="{{ url('assets/frontend/img/icon/service_card_3.svg') }}" alt="Icon">
                            <span class="dots"></span>
                        </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="service-card">
                        ...
                        <div class="shape-icon">
                            <img src="{{ url('assets/frontend/img/icon/service_card_4.svg') }}" alt="Icon">
                            <span class="dots"></span>
                        </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="service-card">
                        ...
                        <div class="shape-icon">
                            <img src="{{ url('assets/frontend/img/icon/service_card_5.svg') }}" alt="Icon">
                            <span class="dots"></span>
                        </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="service-card">
                        ...
                        <div class="shape-icon">
                            <img src="{{ url('assets/frontend/img/icon/service_card_6.svg') }}" alt="Icon">
                            <span class="dots"></span>
                        </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="service-featured">
                                <div class="service-featured_content">
                                    <div class="shape-icon">
                                        <img src="{{ url('assets/frontend/img/icon/service_featured_1.svg') }}" alt="Icon">
                                        <span class="dots"></span>
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="service-featured">
                                <div class="service-featured_content">
                                    <div class="shape-icon">
                                        <img src="{{ url('assets/frontend/img/icon/service_featured_2.svg') }}" alt="Icon">
                                        <span class="dots"></span>
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="service-featured">
                                <div class="service-featured_content">
                                    <div class="shape-icon">
                                        <img src="{{ url('assets/frontend/img/icon/service_featured_3.svg') }}" alt="Icon">
                                        <span class="dots"></span>
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="service-featured">
                                <div class="service-featured_content">
                                    <div class="shape-icon">
                                        <img src="{{ url('assets/frontend/img/icon/service_featured_4.svg') }}" alt="Icon">
                                        <span class="dots"></span>
                                    </div>
                                    <h3 class="box-title"><a href="service-details.html">Machine Learning</a></h3>
                                    <p class="service-featured_text">Conveniently promote transparent materials and stand-alone strategic theme areas.</p>
    ...
    <section class="bg-top-right overflow-hidden space" id="blog-sec" data-bg-src="{{ url('assets/frontend/img/bg/blog_bg_1.png') }}">
