            ...
            <div class="row justify-content-lg-between justify-content-center align-items-center">
                <div class="col-lg-6 col-sm-9 pe-xl-5">
                    <div class="title-area text-center text-lg-start">
                        ...
                        <h2 class="sec-title">Become an Industry Leader by  <span class="text-theme">Powering Innovation with AI</span></h2>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-9 pe-xl-5">
                    <div class="sub-description-area text-lg-start">
                        <p>We help businesses turn AI from an idea into real, working solutions. With the right strategy, data, and technology, SC Technologies enables you to innovate faster, make smarter decisions, and stay ahead of the competition using AI that actually delivers results.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <div class="title-area text-left">
                        <h2 class="sec-title">Our Professional AI Consulting Service</h2>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="title-area text-left me-xl-5 ms-xl-5">
                        <p>SC Technologies provides end-to-end AI and data science services to help businesses automate, innovate, and scale intelligently. We design AI solutions that integrate seamlessly into your systems and workflows. Every model is built for performance, security, and measurable ROI.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="service-box2 wow fadeInRight">
                        ...
                        <div class="service-box2_content">
                            ...
                            <h3 class="box-title">Generative AI</h3>
                            <p class="service-box2_text">Build AI systems for content creation, chatbots, code generation, and automation.</p>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="service-box2 wow fadeInRight">
                        ...
                        <div class="service-box2_content">
                            ...
                            <h3 class="box-title">AI Consulting</h3>
                            <p class="service-box2_text">Strategic guidance to identify, plan, and implement AI solutions aligned with business goals.</p>
                            <span class="icon-btn"><i class="fa-regular fa-arrow-right"></i></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="service-box2 wow fadeInRight">
                        ...
                        <div class="service-box2_content">
                            ...
                            <h3 class="box-title">Agentic AI</h3>
                            <p class="service-box2_text">Develop autonomous AI agents that plan, reason, and execute complex workflows.</p>
                            <span class="icon-btn"><i class="fa-regular fa-arrow-right"></i></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="service-box2 wow fadeInRight">
                        ...
                        <div class="service-box2_content">
                            ...
                            <p class="service-box2_text">Transform raw data into insights using predictive modeling and analytics.</p>
                            <span class="icon-btn"><i class="fa-regular fa-arrow-right"></i></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="service-box2 ">
                        ...
                        <div class="service-box2_content">
                            ...
                            <p class="service-box2_text">Build models for prediction, classification, and recommendation systems.</p>
                            <span class="icon-btn"><i class="fa-regular fa-arrow-right"></i></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="service-box2">
                        ...
                        <div class="service-box2_content">
                            ...
                            <h3 class="box-title">Natural Language Processing</h3>
                            <p class="service-box2_text">Enable AI to understand, analyze, and generate human language.</p>
                            <span class="icon-btn"><i class="fa-regular fa-arrow-right"></i></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="service-box2">
                        ...
                        <div class="service-box2_content">
                            ...
                            <h3 class="box-title">Computer Vision</h3>
                            <p class="service-box2_text">Extract intelligence from images and videos using AI-powered vision systems.</p>
                            <span class="icon-btn"><i class="fa-regular fa-arrow-right"></i></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="service-box2">
                        ...
                        <div class="service-box2_content">
                            ...
                            <h3 class="box-title">AI Integration</h3>
                            <p class="service-box2_text">Integrate AI into existing software, apps, CRMs, and enterprise platforms.</p>
                            <span class="icon-btn"><i class="fa-regular fa-arrow-right"></i></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row gy-40">
                    <div class="col-sm-6 col-xl-3 process-card-wrap">
                        <div class="process-card">
                            ...
                            <h2 class="box-title">Problem Discovery</h2>
                            <p class="process-card_text">Analyze business challenges, data readiness, and automation opportunities.</p>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3 process-card-wrap">
                        <div class="process-card">
                            ...
                            <h2 class="box-title">Model Strategy</h2>
                            <p class="process-card_text">Design AI architectures, model selection, and deployment approach.</p>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3 process-card-wrap">
                        <div class="process-card">
                            ...
                            <p class="process-card_text">Build, train, and integrate AI models using secure and scalable frameworks.</p>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3 process-card-wrap">
                        <div class="process-card">
                            ...
                            <h2 class="box-title">Optimization & Scale</h2>
                            <p class="process-card_text">Monitor performance, refine models, and scale AI systems for long-term growth.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="space" id="business-sec">
        <div class="container th-container4">
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <div class="title-area text-left">
                        <h2 class="sec-title">Industries We Empower with Scalable AI Development</h2>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="title-area text-left me-xl-5 ms-xl-5">
                        <p>We help industries adopt scalable AI solutions that improve efficiency, drive smarter decisions, and unlock new growth opportunities. Our AI development is designed to adapt, grow, and deliver real business impact across different sectors.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="service-area4 th-radius5 space" id="service-sec">
        <div class="container th-container4">
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <div class="title-area text-left">
                        <h2 class="sec-title">5 Benefits of Hiring SC Technologies for AI Services</h2>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="title-area text-left me-xl-5 ms-xl-5">
            ...
            <div class="row gy-3 justify-content-center">
                <div class="col-md-4">
                    <div class="service_card4 active text-left">
                        ...
                        <h3 class="box-title">Business-Focused AI</h3>
                        <p class="service_card4_text">AI solutions designed to solve real operational and growth challenges.</p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="service_card4 text-left">
                        ...
                        <h3 class="box-title">Advanced Expertise</h3>
                        <p class="service_card4_text">Experience with Gen AI, LLMs, agentic systems, and data science models.</p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="service_card4 active text-left">
                        ...
                        <h3 class="box-title">Secure & Compliant</h3>
                        <p class="service_card4_text">Strong data security, privacy, and ethical AI practices.</p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="service_card4 active text-left">
                        ...
                        <h3 class="box-title">Global Delivery</h3>
                        <p class="service_card4_text">Serving businesses worldwide with enterprise-grade AI solutions.</p>
                    </div>
                </div>
            </div>
            <div class="row my-5">
